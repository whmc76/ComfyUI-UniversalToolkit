...
try:
    from .nodes.tools.text_translator import \
        NODE_CLASS_MAPPINGS as TEXT_TRANSLATOR_MAPPINGS
    from .nodes.tools.text_translator import \
        NODE_DISPLAY_NAME_MAPPINGS as TEXT_TRANSLATOR_DISPLAY
except ImportError:
    TEXT_TRANSLATOR_MAPPINGS = {}
    TEXT_TRANSLATOR_DISPLAY = {}
...
NODE_CLASS_MAPPINGS.update(TEXT_TRANSLATOR_MAPPINGS)
...
NODE_DISPLAY_NAME_MAPPINGS.update(TEXT_TRANSLATOR_DISPLAY)
